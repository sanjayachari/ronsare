...
const Ecosystem = () => {
  return (
    ...
    <div className="w-full bg-[#BCC5F2] bg-opacity-40 rounded-t-3xl">
      <div className=" rounded-t-2xl w-full px-4 sm:px-6 md:px-12 xl:px-10 xxl:px-20 max-w-screen-xxxl mx-auto flex items-center pt-10 md:pt-40 pb-10">
      <div className="flex flex-col items-start justify-center">
        <h1 className="text-2xl sm:text-3xl md:text-4xl xl:text-5xl font-semibold text-[#0732EF] my-4">
          How we can help
        </h1>
