...
const Manufacturing = () => {
  return (
    <section className="bg-gradient-to-b from-white to-gray-200 py-20">
      <div className="mt-[60px] md:mt-[90px] w-full flex flex-col items-center px-6 sm:px-2 md:px-16 xl:px-24 max-w-screen-xxxl mx-auto">
        <div className="text-center max-w-3xl">
          <h2 className="text-2xl sm:text-3xl md:text-4xl xl:text-5xl font-extrabold text-[#0732EF] ">Ronsare Manufacturing Expertise</h2>
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-8 w-full max-w-5xl p-2">
          {[
            ...
            <div key={index} className="bg-white shadow-lg rounded-2xl p-8 w-full text-center flex flex-col items-center md:w-[200px] border-t-4 border-[#0732EF]">
        ...
        <div className="mt-10 p-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 w-full max-w-5xl">
